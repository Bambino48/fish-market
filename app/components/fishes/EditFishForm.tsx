...
export default function EditFishForm({ fish }: EditFishFormProps) {
    ...
    const [existingImageUrl, setExistingImageUrl] = useState(fish.imageUrl || "");
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            const res = await fetch(`/api/fishes/${fish.id}`, {
                method: "PATCH",
                headers: {
            ...
            <div className="grid gap-5">
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-2xl border border-slate-300 bg-white py-3 pl-11 pr-4 text-sm text-slate-900 outline-none transition focus:border-sky-500 focus:ring-4 focus:ring-sky-100"
                            required
                        />
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <label className="flex items-center gap-3 text-sm font-medium text-slate-700">
                        ...
                        />
                        Afficher cette annonce comme disponible
                    </label>
                </div>
                    ...
                    <label className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-3xl border border-dashed border-slate-300 bg-slate-50 px-6 py-8 text-center transition hover:border-sky-400 hover:bg-sky-50">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-slate-900">
                                {imageFile ? imageFile.name : existingImageUrl ? "Image actuelle enregistrée" : "Choisir une image"}
                            </p>
