            ...
            <div className="flex items-center gap-4">
              <div className="relative h-16 w-16 overflow-hidden rounded-2xl bg-white shadow-sm">
                {user.profileImageUrl ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center text-lg font-bold text-sky-700">
                    {initials}
                  </div>
                )}
              </div>
          ...
          <div className="flex items-center gap-4">
            <div className="relative h-16 w-16 overflow-hidden rounded-2xl bg-sky-100">
              {user.profileImageUrl ? (
                ...
                <div className="flex h-full w-full items-center justify-center text-xl font-bold text-sky-700">
                  {initials}
                </div>
              )}
            </div>
